...
const TRANSLATIONS = {
  fr: {
    ...
    cargoStepLabel: "Étape {index} — {location}",
    ...
    cargoViewerCaption: "Vue 3D : état au point de charge le plus important du trajet (étape {index} — {location}).",
  ...
  en: {
    ...
    cargoStepLabel: "Step {index} — {location}",
    ...
    cargoViewerCaption: "3D view: state at the route's heaviest load point (step {index} — {location}).",
