...
const TRANSLATIONS = {
  fr: {
    ...
    colorblindLabel: "Mode daltonien (couleurs des caisses)",
    colorblindBtn: "Daltonien",
    colorblindOff: "Désactivé",
    colorblindProtan: "Protanopie (rouge)",
    colorblindDeutan: "Deutéranopie (vert)",
    colorblindTritan: "Tritanopie (bleu)",
    accessFacesTitle: "Faces accessibles de la soute",
    accessFacesHint: "Coche par où tu accèdes vraiment à ta soute : ça détermine quelle caisse en bloque une autre.",
    ...
    adminGridRotateBtn: "Pivoter 90°",
    adminGridMoveAllBtn: "Tout déplacer",
    adminGridMoveAllBtnActive: "Tout déplacer : ON",
    reserveSpotBtn: "Réserver un emplacement",
    reservationHint:
      "Réserve la place d'un véhicule garé : saisis sa taille en cellules (1 cellule = 1,25 m), clique « Placer », puis glisse la grille virtuelle où tu le gares. Le rangement n'utilisera plus ces emplacements. Propre à ton compte.",
    reservationLen: "Longueur (cellules)",
    reservationWid: "Largeur (cellules)",
    reservationPlaceBtn: "Placer",
    reservationCloseBtn: "Terminer",
    reservationClearBtn: "Effacer",
    reservationVehicleLabel: "Véhicule {l}×{w}",
    reservedScu: "{n} SCU réservés",
    ...
    accessFaceInteriorLeft: "Intérieur gauche",
    accessFaceInteriorRight: "Intérieur droit",
  ...
  en: {
    ...
    colorblindLabel: "Colourblind mode (crate colours)",
    colorblindBtn: "Colourblind",
    colorblindOff: "Off",
    colorblindProtan: "Protanopia (red)",
    colorblindDeutan: "Deuteranopia (green)",
    colorblindTritan: "Tritanopia (blue)",
    accessFacesTitle: "Accessible cargo grid faces",
    accessFacesHint: "Tick how you actually reach your hold: it decides which crate blocks another.",
    accessFaceBack: "Back",
    ...
    adminGridRotateBtn: "Rotate 90°",
    adminGridMoveAllBtn: "Move all",
    adminGridMoveAllBtnActive: "Move all: ON",
    reserveSpotBtn: "Reserve a spot",
    reservationHint:
      "Reserve room for a parked vehicle: enter its size in cells (1 cell = 1.25 m), click “Place”, then drag the virtual grid where you park it. Packing will stop using those spots. Tied to your account.",
    reservationLen: "Length (cells)",
    reservationWid: "Width (cells)",
    reservationPlaceBtn: "Place",
    reservationCloseBtn: "Done",
    reservationClearBtn: "Remove",
    reservationVehicleLabel: "Vehicle {l}×{w}",
    reservedScu: "{n} SCU reserved",
    ...
    accessFaceInteriorLeft: "Interior left",
    accessFaceInteriorRight: "Interior right",
