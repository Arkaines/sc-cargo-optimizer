...
- **Onglet Optimisation du cargo** : range les marchandises des missions incluses dans les vraies soutes du vaisseau sélectionné (dimensions et capacités issues de [FleetYards.net](https://fleetyards.net/tools/cargo-grids/)), en tenant compte du trajet optimisé : chaque module de soute est divisé en couloirs d'accès indépendants, pour qu'une marchandise à livrer tôt ne finisse jamais coincée derrière une autre récupérée après elle (avec un avertissement clair quand ce n'est pas possible). Plan de chargement arrêt par arrêt, et vue 3D interactive (rotation à la souris, vues avant/arrière/gauche/droite) au point du trajet où la charge est la plus importante.
